...
//const uint8_t BXCAN_MAX_IFACE_INDEX = 0;
//const uint32_t BXCAN_BUSYWAIT_DELAY_SYSTEM_CORE_CLOCK = 24000000;
#define BXCAN_MAX_IFACE_INDEX 0
#define BXCAN_BUSYWAIT_DELAY_SYSTEM_CORE_CLOCK 2400000
